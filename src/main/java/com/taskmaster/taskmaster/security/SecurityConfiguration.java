    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
            ...
            .authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET,"/api/v1/qna/answers/me/study/{studyId}").hasRole(UserRole.USER.name())
                .antMatchers(HttpMethod.GET,"/api/v1/qna/questions/me/{studyId}").hasRole(UserRole.USER.name())
                ...
                .antMatchers(HttpMethod.DELETE,"/api/v1/qna/answers/me/study/{studyId}").hasRole(UserRole.USER.name())
                .antMatchers(HttpMethod.DELETE,"/api/v1/qna/answers/study/{studyId}/users/{userId}").hasRole(UserRole.ADMIN.name())
