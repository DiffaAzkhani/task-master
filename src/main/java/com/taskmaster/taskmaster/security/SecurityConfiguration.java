    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
            ...
            .authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET,"/api/v1/qna/answers/me/studies/{studyId}").hasRole(UserRole.USER.name())
                .antMatchers(HttpMethod.GET,"/api/v1/qna/questions/me/studies/{studyId}").hasRole(UserRole.USER.name())
                ...
                .antMatchers(HttpMethod.DELETE,"/api/v1/qna/answers/me/studies/{studyId}").hasRole(UserRole.USER.name())
                .antMatchers(HttpMethod.DELETE,"/api/v1/qna/answers/studies/{studyId}/users/{userId}").hasRole(UserRole.ADMIN.name())
                .antMatchers(HttpMethod.DELETE,"/api/v1/qna/questions/{questionId}").hasRole(UserRole.ADMIN.name())
                .antMatchers(HttpMethod.PATCH,"/api/v1/qna/questions/{questionId}").hasRole(UserRole.ADMIN.name())
                .antMatchers(HttpMethod.PATCH,"/api/v1/qna/answers/me/studies/{studyId}/revision").hasRole(UserRole.USER.name())
